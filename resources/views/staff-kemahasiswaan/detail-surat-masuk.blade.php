    ...
    <div class="card card-body" style="max-width: 100%; margin: 0 auto; padding: 10px;">
        ...
        <table class="table table-bordered" style="max-width: 100%;">
            ...
            <tr>
                ...
                <td>{{ $suratMasuk->tanggal_diajukan ? \Carbon\Carbon::parse($suratMasuk->tanggal_diajukan)->translatedformat('d F Y') : '-' }}
                </td>
            </tr>
            <tr>
            ...
            <div>
                ...
                <form action="{{ route('staff-kemahasiswaan.approve-surat', $suratMasuk->id) }}" method="POST"
                    ...
                    <button type="button" class="btn btn-success" data-bs-toggle="modal"
                        data-bs-target="#approveModal">Setujui</button>
                </form>
                    ...
                    <div class="modal-body">
                        @if ($suratMasuk->jenis_surat === 'Proposal Permohonan Dana')
                            <div class="form-group">
                                ...
                                <input type="number" name="nominal_dana_disetujui" id="nominal_dana_disetujui"
                                    class="form-control" placeholder="Masukkan nominal dana yang disetujui"
                                    value="{{ old('nominal_dana_disetujui') }}" step="1000" required>
                            </div>
                        @else
                            <p class="text-info">Jenis surat ini tidak memerlukan input nominal dana, surat bisa langsung
                                disetujui.</p>
                        @endif
                    </div>
