...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ url('/katalogBuku') }}">
          <i class="bi bi-menu-button-wide"></i><span>Katalog Buku</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ url('/pengembalian') }}">
          <i class="bi bi-journal-text"></i><span>Pengembalian</span>
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="{{ url('/pengunjung') }}">
          <i class="bi bi-person"></i><span>Pengunjung</span>
        </a>
      </li>
    </ul>
  </aside>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      PPL <a href="https://bootstrapmade.com/">SIMPULS</a>
    </div>
  </footer>
