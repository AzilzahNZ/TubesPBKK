...
Route::get('/ormawa.riwayat-pengajuan-surat/{id}/edit', [OrmawaController::class, 'edit'])->name('ormawa.edit-pengajuan-surat');
Route::put('/ormawa.riwayat-pengajuan-surat/{id}', [OrmawaController::class, 'update'])->name('ormawa.update-pengajuan-surat');
